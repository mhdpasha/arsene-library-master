...
<div>
    <div class="container-fluid">
        <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('../assets/img/curved-images/curved0.jpg'); background-position-y: 50%;">
            <span class="mask bg-gradient-{{ (auth()->user()->pustakawan) ? 'primary' : 'info' }} opacity-6"></span>
        </div>
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            <div class="row gx-4">  
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{ (auth()->user()->image) ? asset('storage/'. auth()->user()->image) : "assets/img/miaw.jpg" }}" alt="..." class="w-100 border-radius-lg shadow-sm">
                        <a href="#image" type="button" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2" data-bs-toggle="modal" data-bs-target="#uploadimg">
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm">
                            {{ (auth()->user()->pustakawan) ? 'Pustakawan' : 'Anggota' }}
                        </p>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="/user-profile" method="POST" enctype="multipart/form-data" role="form text-left">
                    ...
                    @endif
                    @if(session('success'))
                        <div class="m-3  alert alert-dark alert-dismissible fade show" id="alert-success" role="alert">
                            <span class="alert-text text-white">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->name }}" type="text" placeholder="Name" id="user-name" name="name" autocomplete="off">
                                        @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('email')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->email }}" type="email" placeholder="@example.com" id="user-email" name="email" autocomplete="off">
                                        @error('email')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.phone" class="form-control-label">{{ __('Nomor Telephone') }}</label>
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="tel" placeholder="62812345678" id="number" name="phone" value="{{ auth()->user()->phone }}" autocomplete="off">
                                        @error('phone')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Jl. Nanas II no. 3" id="name" name="location" value="{{ auth()->user()->location }}" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="@error('user.about')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="about" rows="3" placeholder="Say something about yourself" name="about_me" autocomplete="off">{{ auth()->user()->about_me }}</textarea>
                        </div>
                    </div>
